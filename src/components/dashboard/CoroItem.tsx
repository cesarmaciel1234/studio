...
import { Heart, MessageCircle, Send, ShieldAlert, Clock, AlertTriangle } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">
                Activo: {safeFormat(alert.updatedAt || alert.createdAt, 'HH:mm')}
              </p>
            </div>
          </div>
        ...
        {showComments && (
          <div className="pt-4 space-y-3 animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            <div className="flex gap-2">
              ...
              />
              <Button onClick={handleSendComment} size="icon" className="h-10 w-10 rounded-xl bg-slate-900 shrink-0 transition-transform active:scale-90">
